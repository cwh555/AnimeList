  ...
  return `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><style>
    ...
    <main class="animelist-native-view">
      <section class="al-shell">
        ...
        <div class="al-toolbar"><label class="al-search"><input></label><label class="al-sort al-genre-filter"><select><option>Genre</option></select></label><label class="al-sort"><select><option>Sort</option></select></label><div class="al-view-switch"><button class="al-view-button">G</button><button class="al-view-button">L</button><button class="al-view-button">P</button></div></div>
    ...
    <div class="modal animelist-modal"><div class="modal-content"><div class="al-selected-preview"><img><div><h2>Selected title</h2></div></div><section class="al-media-metadata-section"><h3 class="al-form-section-heading">作品資料</h3><div id="metadata-grid" class="al-media-metadata-grid"><div class="al-media-metadata-item"><div class="al-media-metadata-label">作品形式</div><div class="al-media-metadata-value">TV 動畫</div></div><div class="al-media-metadata-item"><div class="al-media-metadata-label">季度</div><div class="al-media-metadata-value">2021 Q1 (冬季)</div></div><div class="al-media-metadata-item al-media-metadata-item-tags"><div class="al-media-metadata-label">AniList 標籤</div><div class="al-tag-chip-set"><span class="al-tag-chip al-tag-chip-readonly">School</span><span class="al-tag-chip al-tag-chip-readonly">Coming of Age</span></div></div></div></section><form class="al-media-form al-edit-media-form"><label class="al-form-field"><input></label><label class="al-form-field al-form-field-tags"><div class="al-tag-control"><div class="al-tag-chip-set"><div class="al-tag-chip al-tag-chip-selected"><span>重看</span></div><button id="tag-add" class="al-tag-add-button">+</button></div></div></label><div id="serial-row" class="al-volume-row"><div class="al-volume-row-fields"><label class="al-form-field"><input></label></div><div class="al-serial-cover-panel"><button class="al-serial-cover-button"></button><small class="al-serial-cover-status">Cover</small><div class="al-serial-cover-actions"><button>R</button><button>C</button></div></div><div class="al-volume-row-actions"><button class="al-delete-button">Remove</button></div></div></form><div class="al-modal-actions"><button>Cancel</button><button class="mod-cta">Save</button></div></div></div>
