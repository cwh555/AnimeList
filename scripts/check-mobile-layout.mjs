...
function fixture(mode) {
  ...
  return `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><style>
    ...
    <div class="modal animelist-modal"><div class="modal-content"><div class="al-selected-preview"><img><div><h2>Selected title</h2></div></div><form class="al-media-form"><label class="al-form-field"><input></label><label class="al-form-field"><input></label><div id="serial-row" class="al-volume-row"><div class="al-volume-row-fields"><label class="al-form-field"><input></label></div><div class="al-serial-cover-panel"><button class="al-serial-cover-button"></button><small class="al-serial-cover-status">Cover</small><div class="al-serial-cover-actions"><button>R</button><button>C</button></div></div><div class="al-volume-row-actions"><button class="al-delete-button">Remove</button></div></div></form><div class="al-modal-actions"><button>Cancel</button><button class="mod-cta">Save</button></div></div></div>
