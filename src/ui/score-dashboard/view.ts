...
import { renderScoreDashboardWithBatchDrag } from "./batch-drag";
import { normalizeScoreDashboardScale, SCORE_DASHBOARD_DEFAULT_SCALE } from "../../domain/score-dashboard/model";
